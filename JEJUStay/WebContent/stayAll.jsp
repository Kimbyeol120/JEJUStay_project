      ...
      <div class="row">
        <div class="col">
          ...
          <ul class="nav nav-tabs" style="padding-top: 50px">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost:9000/JEJUStay/stayHotel.jsp">호텔</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost:9000/JEJUStay/stayPension.jsp">펜션</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost:9000/JEJUStay/stayResort.jsp">리조트</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost:9000/JEJUStay/stayCaravan.jsp">카라반</a>
            </li>
          </ul>
        </div>
      </div>
...
<div class="container" style="padding-top: 40px;  padding-left: 60px;">      
 	<form name="search" class="form-horizontal" action="http://localhost:9000/JEJUStay/stayAll.jsp?" method="post" onSubmit="return checkForm()">
		...
		<div>
			<table border="0" style="margin-left:50px;">
				<tr><td rowspan="3" width="700">
					<a href="http://localhost:9000/JEJUStay/stayRoom.jsp?code=<%=sdto.getStayCode()%>"><img src="media/<%=sdto.getStayFileName()%>.PNG" width="650" height="250"></a></td>
				...
				<tr><td align=right style="padding-right:20px"><a href="http://localhost:9000/JEJUStay/stayRoom.jsp?code=<%=sdto.getStayCode()%>" class="btn btn-light" role="button"> 예약하기  &raquo;</a></td></tr>
			</table>
			<br><br><br>	
		<%
     			}
