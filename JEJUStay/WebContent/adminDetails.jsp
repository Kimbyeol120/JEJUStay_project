...
<body>
	...
	<div id="content_box" class="container">
		<input type="button" class="btn btn-warning btn-lg"
			...
			onclick="location.href='http://localhost:9000/JEJUStay/admin.jsp'" value="목록보기" >
			<%
			...
			<table class="table">
				<tr>
					...
					<td class="col-md-1"><input type="button"
						...
						onclick="location.href='http://localhost:9000/JEJUStay/stayRoom.jsp?code=<%=reservedto.getStayCode()%>'">
					</td>
				</tr>
			</table>
		</div>
