	...
	<div class="container" style="padding-top: 50px">
		<table class="table table-hover">
			...
			<tr>
				...
				<td><%=total %></td>
				<td><a href="http://localhost:9000/JEJUStay/removeCart.jsp?code=<%=staydto.getStayCode()%>" class="btn btn-secondary btn-sm">삭제</a></td>
			</tr>
			<%
		...
		<br> <form name="reserve" class="form-horizontal" action="http://localhost:9000/JEJUStay/reserveConfirm.jsp?code=<%=staydto.getStayCode()%>" 
				method="post" onSubmit="return showPopup()">
		<a href="http://localhost:9000/JEJUStay/stayAll.jsp" type="button" class="btn btn-light"
...
<script type="text/javascript">
	 function showPopup() {	
		 if(${sessionId==null}){
			  alert("로그인 후 이용해주세요.");
			  location.href = "http://localhost:9000/JEJUStay/login.jsp";
			  return false;
		  }
		 if(${dateCnt>0}){
