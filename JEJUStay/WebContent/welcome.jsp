		...
		<div class="container" style="padding-top: 50px" >
		  <div class="row" >
			<div class="form-group" >
				 <form name="search" class="form-inline" action="http://localhost:9000/JEJUStay/stayAll.jsp?" style="padding-left: 250px" onSubmit="return checkForm()">					
		  ...
		  <br>
		    <div class="form-group row" >
				<div class="col-sm-5" style="padding-left: 220px">
					<a href="http://localhost:9000/JEJUStay/stayHotel.jsp"><img src="media/main2.png" width="280" height="180"></a>
				</div>
				<div class="col-sm-5" style="padding-left: 100px">
					<a href="http://localhost:9000/JEJUStay/stayPension.jsp"><img src="media/main3.png" width="280" height="180"></a>
				</div>
		  	</div>
			<div class="form-group row">
				<div class="col-sm-5" style="padding-left: 220px">
					<a href="http://localhost:9000/JEJUStay/stayResort.jsp"><img src="media/main4.png" width="280" height="180"></a>
				</div>
				<div class="col-sm-5" style="padding-left: 100px">
					<a href="http://localhost:9000/JEJUStay/stayCaravan.jsp"><img src="media/main5.png" width="280" height="180"></a>
				</div>
